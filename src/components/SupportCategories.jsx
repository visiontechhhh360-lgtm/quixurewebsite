        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {CATEGORIES.map(({ icon: Icon, title, desc }, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative rounded-3xl border border-white/10 bg-white/5 p-7 text-left overflow-hidden hover:border-teal-400/40 transition-colors cursor-pointer"
            >
