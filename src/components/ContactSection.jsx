    ...
    <section className="relative bg-ink-900 px-6 md:px-12 py-28 overflow-hidden">
      ...
      <div className="relative grid lg:grid-cols-2 gap-14 items-start max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="max-w-md text-base text-white/50 leading-relaxed mb-9">
          ...
          <div className="flex flex-col gap-4">
            {POINTS.map(({ icon: Icon, label }) => (
              <div key={label} className="flex items-center gap-3">
                <span className="grid h-10 w-10 flex-shrink-0 place-items-center rounded-full border border-teal-400/30 bg-teal-400/10 text-teal-300">
                  <Icon size={17} />
                </span>
        ...
        <motion.form
          ...
          className="relative rounded-[28px] border border-white/10 bg-white/5 backdrop-blur-xl p-8 flex flex-col gap-5"
        >
          ...
          <div className="flex flex-col gap-2 text-left">
            ...
            <textarea
              ...
              className="resize-none rounded-xl border border-white/10 bg-ink-950/60 px-4 py-3.5 text-sm text-white placeholder:text-white/30 outline-none focus:border-teal-400/60 transition-colors"
            />
          </div>
