            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl border overflow-hidden transition-colors ${
                  isOpen ? "border-teal-400/40 bg-teal-400/5" : "border-white/10 bg-white/5"
                }`}
              >
                <button
                ...
                >
                  ...
                  <motion.span
                    ...
                    className="grid h-7 w-7 flex-shrink-0 place-items-center rounded-full bg-white/10 text-teal-300"
                  >
                    <ChevronDown size={14} />
                  </motion.span>
                </button>
